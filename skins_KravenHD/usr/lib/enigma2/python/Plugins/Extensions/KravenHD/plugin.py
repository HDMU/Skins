...
config.plugins.KravenHD.InfobarWeatherWidget = ConfigSelection(default="infobar-weather-none", choices = [
				...
				("infobar-weather-original", _("Original only for Z1+X2 Infobar")),
				("infobar-weather-big", _("Big not for Z1+X2 Infobar"))
				])	
			
config.plugins.KravenHD.InfobarClockWidget = ConfigSelection(default="infobar-clock-none", choices = [
				("infobar-clock-none", _("Off for ZZ1 and Adroid")),
...
<screen name="KravenHD-Setup" position="0,0" size="1280,720" flags="wfNoBorder" backgroundColor="transparent">
  ...
  <ePixmap position="830,494" size="200,200" pixmap="KravenHD/Logo_small.png" alphatest="blend" />
