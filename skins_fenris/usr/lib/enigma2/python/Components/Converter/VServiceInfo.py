...
class VServiceInfo(Converter, object):
    ...
    def __init__(self, type):
        ...
        self.type, self.interesting_events = {'AudioTracksAvailable': (self.AUDIOTRACKS_AVAILABLE, (iPlayableService.evUpdatedInfo,)),
         'SubtitlesAvailable': (self.SUBTITLES_AVAILABLE, (iPlayableService.evUpdatedInfo,))}[type]
